---
description: Converts any HTML design into Shopify Dawn theme Liquid code. Apply to all .liquid and .css files in a Shopify Dawn theme. Triggers when the user asks to convert HTML, add sections, fix styles, or implement a design in Shopify.
globs:
  - "sections/*.liquid"
  - "assets/*.css"
  - "templates/*.json"
...
# html-to-shopify-dawn (Cursor Rule)

> **When to apply**: Any time the user shares HTML and wants it in Shopify, asks to add/edit a Dawn section, or asks to fix a CSS layout issue in Dawn.
